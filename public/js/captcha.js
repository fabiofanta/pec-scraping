...
var Captcha = /** @class */ (function () {
    function Captcha(link, param) {
        this.parameters = param;
        this.captchaLink = link;
    }
    Captcha.prototype.initCaptcha = function () {
        return __awaiter(this, void 0, void 0, function () {
            var captchaInit;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1["default"].post(this.captchaLink, this.parameters)];
                    case 1:
                        captchaInit = _a.sent();
                        return [2 /*return*/, captchaInit];
                }
            });
        });
    };
    Captcha.prototype.resolveCaptcha = function (captchaInit) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
