...
var ServerRequest = /** @class */ (function () {
    function ServerRequest(conf, pay, url) {
        this.config = conf;
        this.payload = pay;
        this.url = url;
    }
    ServerRequest.prototype.postData = function (vat) {
        return __awaiter(this, void 0, void 0, function () {
            var postRequest, body, $, business, pec, payload, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1["default"].post(this.url, this.payload, this.config)];
                    case 1:
                        postRequest = _a.sent();
